...
//Changes I made are included as comments here
(function(){
...
var svg = d3.select("div#opinion_1")
  .append("svg")
...
//Change data
var data = [
  { gender: "Men", support: "48", oppose: "45", no_opinion: "6" },
  { gender: "Women ", support: "46", oppose: "44", no_opinion: "10" },
];
...
var dataset = d3.layout.stack()(["support","oppose","no_opinion"].map(function(fruit) {
  return data.map(function(d) {
    return {x: (d.gender), y: +d[fruit]};
  });
}));
...
// Change colors
var colors = ["#1B4F72", "#2E86C1", "#85C1E9"];
